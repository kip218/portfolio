  ...
  return (
    <div className="navbar sticky top-0 bg-white shadow-md h-28 z-50">
      <div className="navbar-start">
        ...
        <a href="/" className={`${kanit.className} text-2xl p-2 transform md:-translate-x-12 transition-all duration-1000`}>
          Kang-In Park
        </a>
      </div>
  ...
  return (
    <ul className="flex flex-wrap justify-center">
      <li className="pl-8 pr-2 md:pr-8 hover:-translate-y-6 transition-all duration-700">
        <svg className="fill-current w-14 h-14 md:w-20 md:h-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
    ...
    <ul className="flex flex-col justify-between md:text-xl w-full">
      <li className="py-2 md:py-4 transition-all duration-500">
        <div className="collapse collapse-arrow border border-gray-400 hover:bg-gray-100 bg-white shadow-lg transition-all duration-500 ease-in-out">
          ...
          <div className="collapse-title">
            <Image src="/securityscorecard.png" width={512} height={512} className="w-10 h-10 inline mr-4"/>
            SecurityScorecard
          </div>
          <div className="collapse-content bg-white"> 
            <p className="pt-4">
              Signal Intelligence Collections Intern<br/>
              2022
            </p>
          </div>
        </div>
      ...
      <li className="py-2 md:py-4 transition-all duration-500">
        <div className="collapse collapse-arrow border border-gray-400 hover:bg-gray-100 bg-white shadow-lg transition-all duration-500 ease-in-out">
          <input type="checkbox"/> 
          <div className="collapse-title">
            <Image src="/rokaf.png" width={600} height={600} className="w-10 h-10 inline mr-4"/>
            Republic of Korea Air Force
          </div>
          <div className="collapse-content"> 
            <p className="pt-4">
              Enlisted Aircraft Mechanic<br/>
              2019-2021
            </p>
          </div>
        </div>
      ...
      <li className="py-2 md:py-4 transition-all duration-500">
        <div className="collapse collapse-arrow border border-gray-400 hover:bg-gray-100 bg-white shadow-lg transition-all duration-500 ease-in-out">
          <input type="checkbox"/> 
          <div className="collapse-title">
            <Image src="/nyu.png" width={450} height={450} className="w-10 h-10 inline mr-4"/>
            NYU TRIO Scholars
          </div>
          <div className="collapse-content"> 
            <p className="pt-4">
