...
export default function Home() {
  return (
    <main className="overflow-y-scroll scroll-smooth scrollbar">
      <div id="home" className="flex flex-col h-full min-h-[650px] items-center justify-center">
        <div className="hero flex-col">
          <div className="hero-content flex-col md:flex-row-reverse">
            <Image src="/profile.png" width={1200} height={1200} className="max-w-sm rounded-full border-2 border-black shadow-2xl w-40 sm:w-56 md:w-80 transition-all duration-1000"/>
            <div>
              <h1 className="text-3xl md:text-5xl font-bold transition-all duration-1000">
                Back-End Developer 👋
              </h1>
              <p className="py-6 text-xl">Hi, I'm Kang-In Park. A back-end developer based in New York.</p>
              <Socials/>
            </div>
          </div>
        </div>
      ...
      <div id="experience" className="flex flex-col h-full min-h-[650px] items-center justify-center bg-white">
        <div className="hero flex-col">
